...
def train_model(net, model_name, train_set, device, max_epochs=50, patience=7, batch_size=256, overwrite=False, plot_validation=False):
...
for act_fn_name in act_fn_by_name:
    ...
    train_model(net_actfn, f"FashionMNIST_{act_fn_name}",train_set, device, max_epochs=2,
                      overwrite=False)
